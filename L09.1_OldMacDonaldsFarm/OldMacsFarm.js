...
(function (L091_OldMacsFarm) {
    ...
    function showAnimals() {
        console.log("Animals");
        let cow = new L091_OldMacsFarm.Animal("cow", "Milka", "Muh", "grass", 10);
        let dog = new L091_OldMacsFarm.Animal("dog", "Bello", "Wuff", "meat", 5);
        let chicken = new L091_OldMacsFarm.Animal("chicken", "Henri", "Boak", "corn", 30);
        let goat = new L091_OldMacsFarm.Animal("goat", "Willi", "Ähhh", "hay", 12);
        let sheep = new L091_OldMacsFarm.Animal("sheep", "Wolli", "Määh", "oats", 25);
        animals.push(cow);
        animals.push(dog);
    ...
    function feedAnimals() {
        ...
        let goatDiv = document.getElementById("goat");
        let sheepDiv = document.getElementById("sheep");
        cowDiv.innerHTML += "<br>" + animals[0].name + " ate " + animals[0].storage + " kg of " + animals[0].food + "<br>";
        dogDiv.innerHTML += "<br>" + animals[1].name + " ate " + animals[1].storage + " kg of " + animals[1].food + "<br>";
        chickenDiv.innerHTML += "<br>" + animals[2].name + " ate " + animals[2].storage + " " + animals[2].food + "<br>";
        goatDiv.innerHTML += "<br>" + animals[3].name + " ate " + animals[3].storage + " kg of " + animals[3].food + "<br>";
        sheepDiv.innerHTML += "<br>" + animals[4].name + " ate " + animals[4].storage + " kg of " + animals[4].food + "<br>";
        showFood();
    }
    function singSong() {
        let cowDiv = document.getElementById("cow");
