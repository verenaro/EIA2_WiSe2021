...
namespace L091_OldMacsFarm {
    ...
    function showAnimals(): void {
        console.log("Animals");
        let cow: Animal = new Animal("cow", "Milka", "Muh", "grass", 10);
        let dog: Animal = new Animal("dog", "Bello", "Wuff", "meat", 5);
        let chicken: Animal = new Animal("chicken", "Henri", "Boak", "corn", 30);
        let goat: Animal = new Animal("goat", "Willi", "Ähhh", "hay", 12);
        let sheep: Animal = new Animal("sheep", "Wolli", "Määh", "oats", 25);
